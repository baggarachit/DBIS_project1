...
export class NewExamFormComponent implements OnInit {
 ...
 c_id: any;
  ...
  onSubmit(){
    this.router.navigate(['/display-paper'],{ Params: { course: this.c_id, difficulty: this.empForm.value.Difficulty, duration: this.empForm.value.Duration, marks: this.empForm.value.Marks, topics: this.empForm.value.Topics}});
