...
export class DetailsService {
  ...
  // getData_inn(matchIdFromRoute: Number) : Observable<any>{
  //   let url1="http://localhost:3080/match/i1/"+String(matchIdFromRoute);
  //   let x = this.http.get(url1);
  //   let url2="http://localhost:3080/match/i2/"+String(matchIdFromRoute);
  //   let y = this.http.get(url2);
  //   return x, y;
